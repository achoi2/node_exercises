...
// console.log(functions.printNumbers(1,10));
// console.log(functions.printSquare(5));
// console.log(functions.printBox(3,3));
// console.log(functions.printBox(3, 3));
// console.log(functions.printBanner('hello world'));
